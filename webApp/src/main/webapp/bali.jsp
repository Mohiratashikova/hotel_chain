        ...
        <section class="rooms" id="services">
            <div class="container">
                ...
                <div class="grid rooms-grid">
                    ...
                    <div class="grid-item featured-rooms">
                        <div class="image-wrap">
                            <img class="room-image" src="./images/restaurant.jpg" alt="">
                            <h5 class="room-name">Restaurant</h5>
                        </div>
                        <div class="room-info-wrap">
                            <p class="paragraph">
                                All dishes are prepared in the restaurant kitchen, they are able to cater for most dietary needs, with most sauces, soups and gravy all created gluten free.
                            </p>
                        </div>
                    </div>
                </div>
