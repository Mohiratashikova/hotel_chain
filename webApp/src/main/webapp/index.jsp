        ...
        <div class="container">
            <nav class="nav">
                ...
                <ul class="nav-list">
                    ...
                    <li class="nav-item">
                        <a href="#hotels" class="nav-link">Reservations</a>
                    </li>
                    <li class="nav-item">
	...
	out.print(session.getAttribute("username"));
                    ...
                    <li class="nav-item">
                     ...
                     <li class="nav-item">
                        ...
                        <a href="./managerSeasons.jsp" class="nav-link">ManagerManageSeasons</a>
                        <a href="./service.html" class="nav-link">Deskclerk</a>
                    </li>
                    <li class="nav-item">
                        <a href="./manageSchedule.jsp" class="nav-link">Schedule</a>
                    </li>
                </ul>
            </nav>
        </div>
